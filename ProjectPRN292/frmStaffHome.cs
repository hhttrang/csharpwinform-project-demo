...
namespace ProjectPRN292
{
    ...
    {  
                ...
                for (int z = 0; z < dtRoom.Columns.Count; z++)
                {
                    ...
                    switch (z)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            r.PricePerNight = float.Parse(dtRoom.Rows[index][z].ToString());
                            break;
                        case 3:
        ...
        private void btnRecepMana_Click(object sender, EventArgs e)
        {
            this.Hide();
            Thread t = new Thread(new ThreadStart(() => ShowForm(1)));
            t.Start();
            this.Close();
        }
        ...
        {
            this.Hide();
            Thread t = new Thread(new ThreadStart(() => ShowForm(5)));
            t.Start();
            this.Close();
        }
